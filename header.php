...
<header id="masthead" class="site-header bg-white shadow-soft sticky top-0 z-50 transition-shadow duration-300" role="banner">
    <nav class="container mx-auto px-4 lg:px-6" role="navigation" aria-label="<?php _e('Main Navigation', 'fitlife-pro'); ?>">
        <div class="flex items-center justify-between gap-6 py-4">
            ...
            <!-- Header Actions -->
            <div class="header-actions hidden lg:flex flex-shrink-0 gap-3 items-center">
                <!-- Dark Mode Toggle -->
                <button
                    type="button"
                    id="dark-mode-toggle"
                    class="inline-flex items-center justify-center p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-primary-500 focus:ring-opacity-50"
                    aria-label="<?php _e('Toggle dark mode', 'fitlife-pro'); ?>"
                    title="<?php _e('Toggle dark mode', 'fitlife-pro'); ?>">
